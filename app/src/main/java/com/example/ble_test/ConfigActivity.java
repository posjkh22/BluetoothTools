...
public class ConfigActivity extends AppCompatActivity {
    ...
    private Button btn_config_scan_only_ble_combo_;
    ...
    private TextView tv_config_scan_only_ble_combo_;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_config_scan_only_ble_combo_ = (Button) findViewById(R.id.btn_config_scan_only_ble_combo);
        ...
        tv_config_scan_only_ble_combo_ = (TextView) findViewById(R.id.tv_config_scan_only_ble_combo);
        ...
        tv_config_scan_only_ble_combo_.setText(Boolean.toString(isMacAddressFilterEnabled));
        ...
        btn_config_scan_only_ble_combo_.setOnClickListener( (v) -> { setScanFilter(v); });
    ...
    public void setScanFilter(View v) {
        if (isMacAddressFilterEnabled) {
            isMacAddressFilterEnabled = false;
        }
        else {
            isMacAddressFilterEnabled = true;
        }
        tv_config_scan_only_ble_combo_.setText(Boolean.toString(isMacAddressFilterEnabled));
    }
